...
////////////////////////////////////////////////////////////////////////////////
EXIFReader::EXIFReader(EXIFInfo *info) {
  if (info) {
    m_exifinfo = info;
    freeinfo = false;
  } else {
...
////////////////////////////////////////////////////////////////////////////////
bool EXIFReader::DecodeExif(FILE *hFile) {
  int a;
  int HaveCom = 0;
...
--------------------------------------------------------------------------*/
bool EXIFReader::process_EXIF(unsigned char *CharBuf, unsigned int length) {
...
//--------------------------------------------------------------------------
int EXIFReader::Get16m(void *Short) {
...
--------------------------------------------------------------------------*/
long EXIFReader::Get32s(void *Long) {
  if (MotorolaOrder) {
...
--------------------------------------------------------------------------*/
unsigned long EXIFReader::Get32u(void *Long) {
...
--------------------------------------------------------------------------*/
bool EXIFReader::ProcessExifDir(unsigned char *DirStart, unsigned char *OffsetBase, unsigned ExifLength,
...
////////////////////////////////////////////////////////////////////////////////
void EXIFReader::process_COM(const unsigned char *Data, int length) {
  int ch;
...
////////////////////////////////////////////////////////////////////////////////
void EXIFReader::process_SOFn(const unsigned char *Data, int marker) {
